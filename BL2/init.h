...
#define  exception_soft_init             (exception_vector_table_base + 0x08)
...
#define  r_exception_soft_init           (*(volatile unsigned int *)exception_soft_init)
...
#define  r_exception_fiq                 (*(volatile unsigned int *)exception_irq)
